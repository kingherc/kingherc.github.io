...
> Ο [Ηρακλής Ψαρουδάκης](/about.html) εργάζεται εξ' αποστάσεως από την Ελλάδα ως Κύριος Μηχανικός Λογισμικού στην [Elastic](https://www.elastic.co/), εστιάζοντας στην κατανεμημένη αποδοτικότητα του [Elasticsearch](https://www.elastic.co/elasticsearch/). Προηγουμένως, ήταν Κύριο Μέλος του Τεχνικού Προσωπικού της [Oracle Labs](https://labs.oracle.com/) στη Ζυρίχη της Ελβετίας, επικεντρωνόμενος στον παράλληλο και κατανεμημένο προγραμματισμό και στους φόρτους αναλυτικών εργασιών και τεχνητής νοημοσύνης βάσει γράφων, ειδικά σε εφαρμογές οικονομικού εγκλήματος και συμμόρφωσης. Πριν από την Oracle, ολοκλήρωσε το διδακτορικό του στο εργαστήριο [DIAS](http://dias.epfl.ch) του [EPFL](http://www.epfl.ch/) στη Λωζάνη, εστιάζοντας στην αποδοτικότητα των αναλυτικών φόρτων εργασίας σε βάσες δεδομένων σε διακομιστές πολλαπλών πυρήνων μέσω (α) κοινής χρήσης δεδομένων και εργασίας σε ταυτόχρονα ερωτήματα και (β) προσαρμοστικής τοποθέτησης δεδομένων και προγραμματισμού εργασιών με γνώση NUMA. Κατά τη διάρκεια του διδακτορικού του, συνεργάστηκε με την ομάδα βάσης δεδομένων [SAP HANA](http://scn.sap.com/docs/DOC-26824). Πριν από το διδακτορικό του, ολοκλήρωσε τις σπουδές του ως Ηλεκτρολόγος Μηχανικός & Μηχανικός Υπολογιστών στο [ΕΜΠ](https://www.ntua.gr/) στην Αθήνα.
