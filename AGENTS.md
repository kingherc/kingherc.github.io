...
*   **Presentation posts:** If the blog post is about a Devstaff presentation, follow the ideal example of the 2026-02-12-software-developer-job-hunting-tips.md blog post, otherwise follow the ideal example of the 2023-06-11-devoxx-greece-elasticsearch-presentation.md blog post for presentations. The front matter should have a similar format as the example blog post, including a new ID and permalink, and the post should similarly write a few words about the venue, the title of the presentation, its abstract, reference a downloadable link of the slides .pdf asset, embed a Youtube public recording, and the agenda.